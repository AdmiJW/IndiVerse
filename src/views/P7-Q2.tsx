...
export function P7_Q2(props: PageProps) {

    const onBack = () => {
        props.setState({ ...props.state, page: AppStatePage.Q1 });
    };
    ...
    return <>
        ...
        <p className='mb-8 text-center text-lg font-light'>
            I usually concentrate more on the whole picture, <br/>rather than the small details.
        </p>
